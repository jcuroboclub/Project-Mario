...
class ArduinoTestPacket:
    DELIMITER = b','
    ENCODING = "UTF-8"
    
    def __init__(self, *args, **kwargs):
        """Create an Test Packet.

        Arguments:
        1 Argument   -- A bytes object in the format 'command,data1,data2...'
        2 Arguments  -- First:   Command   (as a bytes object)
                        Second:  Data      (as an array of bytes objects)
